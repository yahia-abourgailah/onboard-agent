...
DEPARTMENTS_PER_FLOOR=[{
    "floor": "B2",
    "departments_and_facilities": "Parking"
},
{
    "floor": "B1",
    "departments_and_facilities": "Parking, Prayer room (masjid) and toilet"
},
{
    "floor": "Ground",
...
MENTORS_FOR_INTERNS = [
    ...
    {
        "name": "Eslam Ashraf",
        "position": "Accounts Payable Section Head",
        "department": "Finance"
    },
    {
        "name": "Mohamed Elmedany",
        "position": "UI/UX Team Leader",
        "department": "Technology"
    },
    {
        "name": "Mohamed Adel",
        "position": "Senior Frontend Developer I",
        "department": "Technology"
    },
        {
        "name": "Mostafa Younis",
